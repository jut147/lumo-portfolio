      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-12">
        ...
        <div className="lg:col-span-2">
          ...
          {project.project_brief_description && (
            <p className="mb-12 text-lg text-muted-foreground">{project.project_brief_description}</p> // Increased margin
          )}
        ...
        <aside className="lg:col-span-1 space-y-8"> {/* Added space-y for spacing between sidebar blocks */}
          {/* Metadata Section */}
          <div className="rounded-lg bg-muted/50 p-6 sticky top-24"> {/* Added sticky positioning */}
             <h2 className="text-xl font-semibold mb-4">Project Details</h2> {/* Add heading */}
             <div className="grid grid-cols-1 gap-3 text-sm"> {/* Change grid to single column & Reduced gap */}
               ...
               {project.services && project.services.length > 0 && (
                 <div className="pt-2"> {/* Remove col-span & Added padding top */}
          ...
          {project.tech_stack && project.tech_stack.length > 0 && (
            <div className="rounded-lg bg-muted/50 p-6 sticky top-[calc(theme(spacing.24)+100px)]"> {/* Add similar styling & Adjust top offset if needed */}
